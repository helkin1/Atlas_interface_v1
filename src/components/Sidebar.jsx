          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ marginTop: 10, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4 }}>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: 18, fontFamily: "inherit", fontWeight: 700, color: "#4C9EFF" }}>{wkSets}</div>
                <div style={{ fontSize: 10, color: t.textDim }}>Sets</div>
              </div>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: 18, fontFamily: "inherit", fontWeight: 700, color: "#3DDC84" }}>{trainDays}</div>
        ...
        <div style={{ background: t.surface, borderRadius: 12, padding: 20, marginBottom: 16, display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ marginTop: 10, textAlign: "center" }}>
              <div style={{ fontSize: 18, fontFamily: "inherit", fontWeight: 700, color: "#4C9EFF" }}>{getDaySets(curDay)}</div>
              ...
              return (
                <div key={m} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "4px 0", borderBottom: `1px solid ${t.border}` }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    <span style={{ fontSize: 9, fontFamily: "inherit", color: t.textDim }}>+{dayPct}%</span>
                    <span style={{ fontSize: 11, fontFamily: "inherit", fontWeight: 600, color: pc }}>{data.pct}%</span>
                  </div>
                </div>
              );
            })}
    ...
    <div>
      ...
      <div style={{ background: t.surface, borderRadius: 12, padding: 20, marginBottom: 16, display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ marginTop: 10, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4 }}>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 18, fontFamily: "inherit", fontWeight: 700, color: "#4C9EFF" }}>{totalSets}</div>
          ...
          {[
            ...
            return (
              <div key={key} style={{ flex: 1, textAlign: "center" }}>
                <div style={{ fontSize: 22, fontFamily: "inherit", fontWeight: 700, color }}>{Math.round(v)}</div>
                ...
                <div style={{ fontSize: 10, fontFamily: "inherit", color: t.textFaint, marginTop: 4 }}>{pct}%</div>
              </div>
            );
          })}
        </div>
          ...
          {wkSets.map((s, i) => {
            ...
            return (
              <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 3 }}>
                <span style={{ fontSize: 10, fontFamily: "inherit", color: sel ? "#4C9EFF" : t.textDim }}>{s}</span>
                <div style={{ width: "100%", height: `${h}%`, background: sel ? "#4C9EFF" : t.border, borderRadius: 4, minHeight: 4, transition: "all 0.3s" }} />
                <span style={{ fontSize: 9, fontFamily: "inherit", color: t.textFaint }}>W{i + 1}</span>
              </div>
            );
          })}
        </div>
