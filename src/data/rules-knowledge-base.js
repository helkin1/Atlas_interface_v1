...
const RULES = [
  ...
  // Minor muscle groups — placeholder confidence (less research available)
  {
    ...
    sources: [
      { ref: "Israetel, M. — RP Ab Hypertrophy Training Tips", type: "expert_recommendation", year: 2023, url: "https://rpstrength.com/blogs/articles/ab-hypertrophy-training-tips" },
      { ref: "RP Volume Landmarks Reference Tool", type: "aggregated_data", year: 2024, url: "https://volume-landmarks-rp-rals.vercel.app/" },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
  ...
  },
  {
    ...
    sources: [
      { ref: "Practitioner consensus — safety-first conservative default", type: "expert_recommendation", year: 2024 },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
  ...
  },
  {
    ...
    sources: [
      { ref: "Israetel, M. — RP Trap Hypertrophy Training Tips", type: "expert_recommendation", year: 2023 },
      { ref: "RP Volume Landmarks Reference Tool", type: "aggregated_data", year: 2024, url: "https://volume-landmarks-rp-rals.vercel.app/" },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
  ...
  },
  {
    ...
    sources: [
      { ref: "Israetel, M. — RP Forearm Hypertrophy Training Tips", type: "expert_recommendation", year: 2023 },
      { ref: "RP Volume Landmarks Reference Tool", type: "aggregated_data", year: 2024, url: "https://volume-landmarks-rp-rals.vercel.app/" },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
  ...
  },
  {
    ...
    sources: [
      { ref: "AAOS — Shoulder Conditioning Protocol", type: "clinical_guideline", year: 2022 },
      { ref: "E3 Rehab — Evidence-based shoulder prehab programming", type: "expert_recommendation", year: 2023 },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
  ...
  },
  {
    ...
    sources: [
      { ref: "Practitioner consensus — trained as biceps synergist", type: "expert_recommendation", year: 2024 },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
  ...
  },
  {
    ...
    sources: [
      { ref: "Israetel, M. — RP Ab Hypertrophy Training Tips (core broadly)", type: "expert_recommendation", year: 2023, url: "https://rpstrength.com/blogs/articles/ab-hypertrophy-training-tips" },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
  ...
  },
  {
    ...
    sources: [
      { ref: "Practitioner consensus — rarely trained directly", type: "expert_recommendation", year: 2024 },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
    notes: "Updated MEV from 2 to 0. MAV/MRV unchanged. See .docs/research-summaries/medium-priority-volume-landmarks.md.",
  },
  {
    ...
    sources: [
      { ref: "Kubo, K. — Squat depth and muscle volume changes", type: "peer_reviewed", year: 2019 },
      { ref: "Vigotsky, A. & Bryanton, M. — Hip extension biomechanics in squats", type: "peer_reviewed", year: 2016 },
    ],
    confidence: "expert_consensus",
    lastReviewed: "2026-03-11",
