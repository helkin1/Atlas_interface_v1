...
const EXERCISES = {
  barbell_bench_press: { name: "Barbell Bench Press", pattern: "push", muscles: [{ name: "Chest", role: "direct", contribution: 1.0 },{ name: "Triceps", role: "partial", contribution: 0.5 },{ name: "Front Delts", role: "partial", contribution: 0.5 }] },
  incline_db_press: { name: "Incline DB Press", pattern: "push", muscles: [{ name: "Upper Chest", role: "direct", contribution: 1.0 },{ name: "Front Delts", role: "partial", contribution: 0.5 },{ name: "Triceps", role: "partial", contribution: 0.5 }] },
  overhead_press: { name: "Overhead Press", pattern: "push", muscles: [{ name: "Front Delts", role: "direct", contribution: 1.0 },{ name: "Triceps", role: "partial", contribution: 0.5 },{ name: "Side Delts", role: "partial", contribution: 0.5 },{ name: "Core", role: "minimal", contribution: 0.25 }] },
  cable_lateral_raise: { name: "Cable Lateral Raise", pattern: "push", muscles: [{ name: "Side Delts", role: "direct", contribution: 1.0 }] },
  tricep_pushdown: { name: "Tricep Pushdown", pattern: "push", muscles: [{ name: "Triceps", role: "direct", contribution: 1.0 }] },
  dumbbell_fly: { name: "Dumbbell Fly", pattern: "push", muscles: [{ name: "Chest", role: "direct", contribution: 1.0 },{ name: "Front Delts", role: "minimal", contribution: 0.25 }] },
  dips: { name: "Dips", pattern: "push", muscles: [{ name: "Chest", role: "direct", contribution: 1.0 },{ name: "Triceps", role: "partial", contribution: 0.5 },{ name: "Front Delts", role: "partial", contribution: 0.5 }] },
  overhead_tri_ext: { name: "Overhead Tricep Ext.", pattern: "push", muscles: [{ name: "Triceps", role: "direct", contribution: 1.0 }] },
  barbell_row: { name: "Barbell Row", pattern: "pull", muscles: [{ name: "Lats", role: "direct", contribution: 1.0 },{ name: "Upper Back", role: "direct", contribution: 1.0 },{ name: "Biceps", role: "partial", contribution: 0.5 },{ name: "Rear Delts", role: "partial", contribution: 0.5 }] },
  pull_up: { name: "Pull-Up", pattern: "pull", muscles: [{ name: "Lats", role: "direct", contribution: 1.0 },{ name: "Biceps", role: "partial", contribution: 0.5 },{ name: "Core", role: "minimal", contribution: 0.25 }] },
  lat_pulldown: { name: "Lat Pulldown", pattern: "pull", muscles: [{ name: "Lats", role: "direct", contribution: 1.0 },{ name: "Biceps", role: "partial", contribution: 0.5 }] },
  seated_cable_row: { name: "Seated Cable Row", pattern: "pull", muscles: [{ name: "Upper Back", role: "direct", contribution: 1.0 },{ name: "Lats", role: "direct", contribution: 1.0 },{ name: "Biceps", role: "partial", contribution: 0.5 }] },
  face_pull: { name: "Face Pull", pattern: "pull", muscles: [{ name: "Rear Delts", role: "direct", contribution: 1.0 },{ name: "Rotator Cuff", role: "direct", contribution: 1.0 },{ name: "Traps", role: "minimal", contribution: 0.25 }] },
  barbell_curl: { name: "Barbell Curl", pattern: "pull", muscles: [{ name: "Biceps", role: "direct", contribution: 1.0 },{ name: "Forearms", role: "minimal", contribution: 0.25 }] },
  hammer_curl: { name: "Hammer Curl", pattern: "pull", muscles: [{ name: "Biceps", role: "direct", contribution: 1.0 },{ name: "Brachialis", role: "direct", contribution: 1.0 },{ name: "Forearms", role: "partial", contribution: 0.5 }] },
  reverse_fly: { name: "Reverse Fly", pattern: "pull", muscles: [{ name: "Rear Delts", role: "direct", contribution: 1.0 },{ name: "Upper Back", role: "minimal", contribution: 0.25 }] },
  barbell_back_squat: { name: "Back Squat", pattern: "legs", muscles: [{ name: "Quads", role: "direct", contribution: 1.0 },{ name: "Glutes", role: "direct", contribution: 1.0 },{ name: "Hamstrings", role: "minimal", contribution: 0.25 },{ name: "Core", role: "minimal", contribution: 0.25 }] },
  romanian_deadlift: { name: "Romanian Deadlift", pattern: "legs", muscles: [{ name: "Hamstrings", role: "direct", contribution: 1.0 },{ name: "Glutes", role: "direct", contribution: 1.0 },{ name: "Lower Back", role: "partial", contribution: 0.5 }] },
  leg_press: { name: "Leg Press", pattern: "legs", muscles: [{ name: "Quads", role: "direct", contribution: 1.0 },{ name: "Glutes", role: "partial", contribution: 0.5 },{ name: "Hamstrings", role: "minimal", contribution: 0.25 }] },
  bulgarian_split_squat: { name: "Bulgarian Split Squat", pattern: "legs", muscles: [{ name: "Quads", role: "direct", contribution: 1.0 },{ name: "Glutes", role: "direct", contribution: 1.0 },{ name: "Hamstrings", role: "minimal", contribution: 0.25 },{ name: "Core", role: "minimal", contribution: 0.25 }] },
  leg_curl: { name: "Leg Curl", pattern: "legs", muscles: [{ name: "Hamstrings", role: "direct", contribution: 1.0 }] },
  leg_extension: { name: "Leg Extension", pattern: "legs", muscles: [{ name: "Quads", role: "direct", contribution: 1.0 }] },
  hip_thrust: { name: "Hip Thrust", pattern: "legs", muscles: [{ name: "Glutes", role: "direct", contribution: 1.0 },{ name: "Hamstrings", role: "partial", contribution: 0.5 }] },
  calf_raise: { name: "Calf Raise", pattern: "legs", muscles: [{ name: "Calves", role: "direct", contribution: 1.0 }] },
};
...
const VOLUME_LANDMARKS = {
  Chest: { mev: 8, mav: 16, mrv: 22 }, "Upper Chest": { mev: 4, mav: 8, mrv: 12 },
  Lats: { mev: 8, mav: 16, mrv: 22 }, "Upper Back": { mev: 8, mav: 16, mrv: 22 },
  "Front Delts": { mev: 4, mav: 8, mrv: 14 }, "Side Delts": { mev: 8, mav: 16, mrv: 22 },
  "Rear Delts": { mev: 6, mav: 12, mrv: 18 }, Triceps: { mev: 6, mav: 12, mrv: 18 },
  Biceps: { mev: 6, mav: 12, mrv: 18 }, Quads: { mev: 8, mav: 16, mrv: 22 },
  Hamstrings: { mev: 6, mav: 12, mrv: 18 }, Glutes: { mev: 4, mav: 10, mrv: 16 },
  Calves: { mev: 6, mav: 12, mrv: 18 }, Core: { mev: 4, mav: 10, mrv: 16 },
  "Lower Back": { mev: 2, mav: 6, mrv: 10 }, Traps: { mev: 4, mav: 10, mrv: 16 },
  Forearms: { mev: 2, mav: 8, mrv: 14 }, "Rotator Cuff": { mev: 2, mav: 6, mrv: 10 },
};

// ============================================================
// EXERCISE DEFAULTS (for plan builder)
// ============================================================
